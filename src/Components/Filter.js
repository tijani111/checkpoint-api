...
export default function Filter({rate,setSearch,setRate,input,inputSrc,inputRate,setInput,setInputRate,setInputSrc,inputDescription,setInputDescription}) {
